...
// It simply puts a bunch of entry to map.
...
// It maps maps to database tables and runs queries on these maps.
func sqlExample(client *hazelcast.Client) {
	sqlService := client.SQL()
	// Separate examples that shows SQL usage of Hazelcast Go Client
